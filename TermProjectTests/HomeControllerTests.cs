...
namespace TermProjectTests
{
    public class HomeControllerTests
    {
        ...
        repo.AddPlayerToDuel(repo.Cards[2].CardID, repo.Cards[0].CardID, guestPlayer.Id);
            repo.AddPlayerToDuel(repo.Cards[2].CardID, repo.Cards[1].CardID, guestPlayer.Id);//test
        ...
        //{
        //    Arrange();
        //    var userManager = new ApplicationUserManager(NSubstitute.Substitute.For<IUserStore<Player>>());


        //    var controller = new HomeController(repo,userManager);
        ...
        //    var controller = new HomeController(repo,userManager);//test
        ...
        //    var controller = new HomeController(repo,userManager);
        //    var highscores = controller.HighScores() as ViewResult;//test
