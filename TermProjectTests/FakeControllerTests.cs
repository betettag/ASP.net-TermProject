...
namespace TermProjectTests
{
    public class FakeControllerTests
    {
        ...
        public void AddPlayerToDuel()
        {
            ...
            repo.Players.Add(guestPlayer);
            repo.Players.Add(seedPlayer);
            int previousPlayers = repo.Players.Count();
            int previousDuels = repo.Tournaments[0].Duels.Count();
            repo.AddPlayerToDuel(repo.Cards[2].CardID, repo.Cards[0].CardID, guestPlayer.Id);//test
            ...
            repo.AddPlayerToDuel(repo.Cards[2].CardID, repo.Cards[1].CardID, seedPlayer.Id);//test2
        ...
        public void UpdateDuelVotesAndScore()
        {
            ...
            repo.Players.Add(seedPlayer);
            //arrange
            repo.UpdateDuelVotesAndScore(repo.Players[0].Id);//test
            //assert
            Assert.True(repo.Players[0].Voted);
            Assert.True(repo.Players[0].Score == 2);
